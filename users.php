...
$auth = new Auth();
$auth->requireLogin();
$auth->requireAdmin(); // Add this line to check for admin privileges

// Set page variables
$pageTitle = "User Management";
$currentPage = "users";

// Rest of your users.php code remains the same...
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-<?= $user['role'] === 'admin' ? 'blue' : 'green' ?>-lt">
                                                <?= ucfirst($user['role']) ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td><?= $user['last_activity'] ? date('Y-m-d H:i', strtotime($user['last_activity'])) : 'Never' ?></td>
                                        <td>
...
<div class="modal modal-blur fade" id="addUserModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="actions/user_actions.php" method="post" class="needs-validation" novalidate>
...
<script>
    ...
    function deleteUser(userId, username) {
        if (confirm(`Are you sure you want to delete user "${username}"?`)) {
            ...
            form.method = 'POST';
            form.action = 'actions/user_actions.php';
